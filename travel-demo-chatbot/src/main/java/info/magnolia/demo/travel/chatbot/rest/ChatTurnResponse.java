...
public class ChatTurnResponse {
    ...
    private List<TourSummary> suggestedTours;

    public ChatTurnResponse() {}

    public ChatTurnResponse(String msg, List<TourSummary> tours) {
        this.assistantMessage = msg;
        this.suggestedTours = tours;
    }
    ...
    public List<TourSummary> getSuggestedTours() {
